                ...
                @forelse ($tiposCondicion as $tipoCondicion)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-indigo-700 dark:text-indigo-300">
                            {{ $tipoCondicion->mandante?->razon_social ?? '—' }}
                        </td>
                        ...
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div class="mt-2">
                                        <!-- Campo Principal (Mandante) -->
                                        <div class="mb-4">
                                            <label for="mandante_id_condicion" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Principal <span class="text-red-500">*</span></label>
                                            <select wire:model.defer="mandante_id_condicion" id="mandante_id_condicion"
                                                    class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-200 @error('mandante_id_condicion') border-red-500 @enderror">
                                                <option value="">-- Seleccionar Principal --</option>
                                                @foreach($mandantes as $m)
                                                    <option value="{{ $m->id }}">{{ $m->razon_social }}</option>
                                                @endforeach
                                            </select>
                                            @error('mandante_id_condicion') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                                        </div>
