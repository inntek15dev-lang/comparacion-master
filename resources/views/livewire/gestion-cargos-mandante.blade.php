<div>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Gestión de Cargos por Principal') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label for="filtroMandanteIdCargo" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Principal</label>
                                    ...
                                    <div class="sm:flex sm:items-start">
                                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                            ...
                                            <div class="mt-4 space-y-4">
                                                <div>
                                                    <label for="mandante_id_cargo_modal" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Principal <span class="text-red-500">*</span></label>
