    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="mb-4">
                    {{-- Se actualiza la ruta para el botón de volver --}}
                    <a href="{{ route('mandante.supervision') }}" 
                ...
                <div>
                    ...
                    {{-- Los componentes hijos se llaman igual, pero ahora dentro del contexto del mandante --}}
