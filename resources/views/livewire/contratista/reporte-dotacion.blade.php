                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg border dark:border-gray-600 mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                            <div>
                                <label for="mandanteId" class="label-form">Principal <span class="text-red-500">*</span></label>
                        ...
                        <div class="mt-4 flex justify-end">
                            <button wire:click="generarReporte" class="btn-primary" wire:loading.attr="disabled" @if(empty($mandanteId)) disabled @endif>
                            ...
                            <div class="overflow-x-auto shadow-md sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="table-cell text-center">No se encontraron trabajadores facturables para el período y los filtros seleccionados.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                    <tfoot class="bg-gray-100 dark:bg-gray-900">
                                        <tr class="font-bold text-gray-800 dark:text-white">
                                            <td class="px-6 py-3 text-right text-sm uppercase" colspan="2">Total General</td>
