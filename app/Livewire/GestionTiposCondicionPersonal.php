...
class GestionTiposCondicionPersonal extends Component
{
    ...
    protected function rules()
    {
        ...
        return [
            ...
            'nombre' => [
                ...
                'min:3',
                'max:255',
                Rule::unique('tipos_condicion_personal', 'nombre')
    ...
    protected $messages = [
        ...
        'nombre.unique' => 'Esta condición personal ya existe para esta Principal.',
    ];
    ...
    {
        $query = TipoCondicionPersonal::query()->with('mandante');
    ...
    public function abrirModalParaEditar(TipoCondicionPersonal $condicion)
    {
        ...
        $this->mandante_id_condicion = $condicion->mandante_id;
    ...
    public function guardarCondicion()
    {
        ...
        // Mapear el campo validado a la columna de la DB
        $validatedData['mandante_id'] = $this->mandante_id_condicion;
        unset($validatedData['mandante_id_condicion']);
